    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/api/v1/shop/nearest").hasAuthority(Role.CUSTOMER)
                        .requestMatchers("/api/v1/shop/{shopId}/queue").hasAuthority(Role.OPERATOR)
                        .requestMatchers("/api/v1/shop/**").hasAuthority(Role.ADMIN)
